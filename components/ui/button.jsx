...
const buttonVariants = cva(
  'inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-semibold transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 active:scale-95',
  {
    variants: {
      variant: {
        default:
        ...
        premium:
          'bg-gradient-to-r from-amber-500 via-yellow-500 to-amber-600 text-white shadow-2xl hover:shadow-amber-500/50 border border-amber-400/50',
      },
      size: {
